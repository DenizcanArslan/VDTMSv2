...
const ChangeDriverConfirmModal = ({ isOpen, onClose, onConfirm }) => {
  return (
    <Dialog
      open={isOpen}
      onClose={onClose}
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4">
        <Dialog.Panel className="mx-auto max-w-md w-full bg-white rounded-lg shadow-xl p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <Dialog.Title className="text-lg font-medium">Change Driver</Dialog.Title>
          </div>

          <div className="space-y-4">
            <p className="text-gray-600">
              This slot has ongoing or completed transports. Changing the driver will:
            </p>
...
export default ChangeDriverConfirmModal; 