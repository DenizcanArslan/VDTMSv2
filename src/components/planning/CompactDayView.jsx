...
import { FiAlertTriangle, FiAlertCircle, FiTruck, FiMapPin, FiBox, FiClock, FiCheck, FiChevronLeft, FiChevronRight } from 'react-icons/fi';
...
const CompactDayView = ({ onSlotClick, highlightedTransports = [] }) => {
  ...
  const { slots, selectedDate, quays, loading } = useAppSelector(state => state.planning);
